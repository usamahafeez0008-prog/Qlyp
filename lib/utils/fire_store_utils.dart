...
class FireStoreUtils {
  ...
  static Future<List<MainServiceModel>> getMainServices() async {
    List<MainServiceModel> list = [];
    await fireStore.collection("main_services").get().then((value) {
      for (var element in value.docs) {
        MainServiceModel model = MainServiceModel.fromJson(element.data());
        list.add(model);
      }
    }).catchError((error) {
      log(error.toString());
  ...
  static Future<List<ServiceModel>> getServiceByMainServiceId(
    ...
    await fireStore
        ...
        .then((value) {
      for (var element in value.docs) {
        ServiceModel model = ServiceModel.fromJson(element.data());
        list.add(model);
      }
    }).catchError((error) {
      log(error.toString());
  ...
  static Future<List<VehicleTypeModel>> getVehicleTypeByServiceId(
    ...
    await fireStore
        ...
        .then((value) {
      for (var element in value.docs) {
        VehicleTypeModel model = VehicleTypeModel.fromJson(element.data());
        list.add(model);
      }
    }).catchError((error) {
      log(error.toString());
